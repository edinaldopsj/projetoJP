...
class MainActivity : AppCompatActivity() {
  ...
  * para consumir a API Random User Generator e exibir uma lista de nomes completos de usuários.
  * 
  * Passo a passo:
  ...
  *    - Cria um ArrayAdapter com o contexto da aplicação, layout pré-definido para cada item da lista e a lista de nomes completos de usuários.
  ...
  * e receba uma lista de nomes completos de usuários gerados aleatoriamente da API Random User Generator,
